inherited fCadProcesso: TfCadProcesso
  Left = 245
  Top = 174
  Caption = 'Processo'
  ClientHeight = 521
  ...
  inherited PageControl1: TPageControl
    ...
    inherited TabSheet2: TTabSheet
      ...
      object CheckDBGrid5: TCheckDBGrid
        Left = 15
        Top = 147
        Width = 685
        Height = 250
  ...
  inherited T: TZQuery
    ...
    object Tordem: TIntegerField
      FieldName = 'ordem'
    end
    object Tcusto: TFloatField
      FieldName = 'custo'
  ...
  object qProcItem: TZQuery
    ...
    SQL.Strings = (
      'select processo_I.*, produto.descricao'
      ' from processo_I'
      
        'left join produto on processo_I.idproduto = produto.id and produ' +
        'to.tipo='#39'M'#39
      'where processo_I.idProcesso = :IDp')
    Params = <
      item
        DataType = ftUnknown
        Name = 'IDp'
    ...
    object qProcItemIdProcesso: TIntegerField
      FieldName = 'IdProcesso'
    end
    object qProcItemUnidade: TWideStringField
      FieldName = 'Unidade'
      Size = 10
    end
  ...
  object upProcItem: TZUpdateSQL
    DeleteSQL.Strings = (
      'DELETE FROM processo_I'
      'WHERE'
      
        '  ((processo_I.Id IS NULL AND :OLD_Id IS NULL) OR (processo_I.Id' +
        ' = :OLD_Id))')
    InsertSQL.Strings = (
      'INSERT INTO processo_I'
      '  (Id, IdProcesso, IdProduto, Unidade)'
      'VALUES'
      '  (:Id, :IdProcesso, :IdProduto, :Unidade)')
    ModifySQL.Strings = (
      'UPDATE processo_I SET'
      '  Id = :Id,'
