...
//            toRemessaBaixarPagoCedente: ATipoOcorrencia := '34';
         ...
         if Titulos[NumeroRegistro].DataVencimento <> 0 then // DATA DE VENCIMENTO DO TÍTULO
         ...
         Registro := Registro + ' '; // BRANCOS         //NumeroRegistro+2
         Registro := Registro + Formatar(IntToStr(nLinha),6,false,'0'); // Nº SEQÜENCIAL DO REGISTRO NO ARQUIVO
         ...
         if tipoMultaBoleto = 'P' then
            Registro := Registro + '2'  //porc.
         else
            Registro := Registro + '1'; //valor
         Registro := Registro + FormatDateTime('ddmmyyyy',Titulos[NumeroRegistro].DataVencimento);
         Registro := Registro + FormatCurr('0000000000000',Titulos[NumeroRegistro].ValorRecebido*100 );
         Registro := Registro + Formatar('',371,true,' '); // em branco
         Registro := Registro + Formatar(IntToStr(nLinha+1),6,false,'0'); // Nº SEQÜENCIAL DO REGISTRO NO ARQUIVO
      ...
      Remessa.Add('9'+
                  Formatar('',393,true,' ')+  //NumeroRegistro+2
                  Formatar(IntToStr(nLinha ),6,false,'0'));
   end;
