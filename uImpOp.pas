...
type
  TfImpOp = class(TForm)
    ...
    RLLabel61: TRLLabel;
    rldbValor1: TRLDBText;
    RLLabel62: TRLLabel;
    RLLabel63: TRLLabel;
    RLDBText60: TRLDBText;
    RLLabel64: TRLLabel;
    rldbValor2: TRLDBText;
    RLLabel65: TRLLabel;
...
procedure TfImpOp.RLBand10AfterPrint(Sender: TObject);
begin
  qRomSubOP.next;
end;

procedure TfImpOp.RLBand10BeforePrint(Sender: TObject; var PrintIt: Boolean);
begin
  qRomSubOP.prior;
end;

procedure TfImpOp.RLBand12AfterPrint(Sender: TObject);
begin
  qRomSubOP.next;
end;

procedure TfImpOp.RLBand12BeforePrint(Sender: TObject; var PrintIt: Boolean);
begin
  qRomSubOP.prior;
end;

procedure TfImpOp.RLBand9BeforePrint(Sender: TObject; var PrintIt: Boolean);
begin
...
procedure TfImpOp.RLPanel1AfterPrint(Sender: TObject);
begin
  rlpanel1.Height := rlpanel1.Height - 20;
end;

procedure TfImpOp.RLSubDetail1BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
   qRomSubOp.Close;
...
procedure TfImpOp.RLSubDetail2BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
   qRomSubOp.Close;
   qRomSubOp.ParamByName('ID').Value := qRomID.asinteger;
...
procedure TfImpOp.rpRomaneioSubOpBeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
  ...
  begin
    ...
    //ajusta Valor
    rldbvalor1.Font.size := rllabel61.Font.Size;
    rldbValor1.Top       := rllabel61.Top;
    rldbValor1.left      := rllabel61.left +rlLabel61.Width  + 2;


    rldbvalor2.Font.size := rllabel64.Font.Size;
    rldbValor2.Top       := rllabel64.Top;
    rldbValor2.left      := rllabel64.left +rlLabel61.Width  + 2;
