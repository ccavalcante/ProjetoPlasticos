inherited fCadFunc: TfCadFunc
  ...
  inherited PageControl1: TPageControl
    ...
    inherited TabSheet2: TTabSheet
      ...
      object Label16: TLabel
        ...
        Width = 137
        Height = 18
        Caption = 'Vencto Exame Peri'#243'dico'
  ...
  inherited T: TZQuery
    ...
    object TSenha: TWideStringField
      FieldName = 'Senha'
      Size = 15
    end
    object TUser: TWideStringField
      FieldName = 'User'
      Size = 15
    end
    object TTipo: TIntegerField
      FieldName = 'Tipo'
    end
    object TAfastamento: TDateTimeField
    ...
    object TNascimento: TDateTimeField
      FieldName = 'Nascimento'
      EditMask = '!##/##/####;1;_'
    end
    ...
    object TNumero: TWideStringField
      FieldName = 'Numero'
      Size = 10
    end
    ...
    object Tcelular: TWideStringField
      FieldName = 'celular'
      EditMask = '(99)999999999;0;_'
      Size = 12
    end
    ...
    object Tvenc_ferias: TDateTimeField
      FieldName = 'venc_ferias'
      EditMask = '!##/##/####;1;_'
    end
    object Tvenc_exame: TDateTimeField
  ...
  inherited up: TZUpdateSQL
    ...
    InsertSQL.Strings = (
      'INSERT INTO "usuario"'
        ...
        '  ("Id", "Nome", "Senha", "Data", "User", "Tipo", "Afastamento",' +
        ' "CPF", '
      
        '   "RG", "Nascimento", "Endereco", "Numero", "Bairro", "Cidade",' +
        ' "Cep", '
      
        '   "UF", "telefone", "celular", "fax", "email", "venc_ferias", "' +
        'venc_exame", '
      '   "loginEspecial", "idvendedor")'
      'VALUES'
      
        '  (:Id, :Nome, :Senha, :Data, :User, :Tipo, :Afastamento, :CPF, ' +
        ':RG, :Nascimento, '
      
        '   :Endereco, :Numero, :Bairro, :Cidade, :Cep, :UF, :telefone, :' +
        'celular, '
      
        '   :fax, :email, :venc_ferias, :venc_exame, :loginEspecial, :idv' +
        'endedor)')
    ModifySQL.Strings = (
      'UPDATE "usuario" SET'
      '  "Id" = :Id,'
      ...
      '  "fax" = :fax,'
      '  "email" = :email,'
      '  "venc_ferias" = :venc_ferias,'
      '  "venc_exame" = :venc_exame,'
  ...
  object qTP: TZQuery
    ...
    Left = 720
    Top = 168
    object qTPId: TIntegerField
      FieldName = 'Id'
    end
    object qTPDescricao: TWideStringField
      FieldName = 'Descricao'
      Size = 50
    end
  end
