inherited fCADTransportadora: TfCADTransportadora
  ...
  inherited T: TZQuery
    ...
    object TPLACA: TWideStringField
      FieldName = 'PLACA'
      EditMask = 'LLL-9999;0;_'
      Size = 10
    end
    object TUF_PLACA: TWideStringField
      FieldName = 'UF_PLACA'
      Size = 2
    end
    ...
    object Tmotorista: TWideStringField
      FieldName = 'motorista'
      Size = 100
    end
    object Tcpf_motorista: TWideStringField
      FieldName = 'cpf_motorista'
      EditMask = '###.###.###-##;0;_'
    end
    object Trenavan: TWideStringField
      FieldName = 'renavan'
    end
    object Tcap_kg: TIntegerField
      FieldName = 'cap_kg'
    end
    object Tcap_mt: TIntegerField
      FieldName = 'cap_mt'
    end
    object Ttara: TIntegerField
      FieldName = 'tara'
    end
  ...
  inherited up: TZUpdateSQL
    DeleteSQL.Strings = (
      ...
      'WHERE'
      '  TRANSPORTADORA.ID = :OLD_ID')
    InsertSQL.Strings = (
      'INSERT INTO TRANSPORTADORA'
      
        '  (ID, NOME, PLACA, UF_PLACA, CNPJ, IE, ENDERECO, CIDADE, UF, BA' +
        'IRRO, IDUSU, '
      
        '   telefone, site, cep, email, tppessoa, tel2, contato, obs, mot' +
        'orista, '
      
        '   cpf_motorista, renavan, cap_kg, cap_mt, tara, idcondfpto, idc' +
        'usto, forma_pgto, '
      '   ex, EmUso)'
      'VALUES'
      
        '  (:ID, :NOME, :PLACA, :UF_PLACA, :CNPJ, :IE, :ENDERECO, :CIDADE' +
        ', :UF, '
      
        '   :BAIRRO, :IDUSU, :telefone, :site, :cep, :email, :tppessoa, :' +
        'tel2, :contato, '
      
        '   :obs, :motorista, :cpf_motorista, :renavan, :cap_kg, :cap_mt,' +
        ' :tara, '
      '   :idcondfpto, :idcusto, :forma_pgto, :ex, :EmUso)')
    ModifySQL.Strings = (
  ...
  object qCon: TZQuery
    ...
    Left = 776
    Top = 81
    object qConid: TIntegerField
      FieldName = 'id'
      Required = True
    end
    object qCondescricao: TWideStringField
      FieldName = 'descricao'
      Size = 100
    end
  end
  object dCon: TDataSource
    DataSet = qCon
    Left = 732
    Top = 83
  end
