...
var
  ...
  vMultaBol : string;
begin
  if DM.BancoMULTA.asfloat > 0 then  // ou testar no titulo.valorrecebido
    vMultaBol :='2' + StringReplace(StringReplace(formatfloat('00.00', DM.bancoMULTA.asfloat),',', '', [rfReplaceAll]), '.', '', [rfReplaceAll] )
  else
    vMultaBol := '00000';
  ...
  begin
    ...
    begin
      ...
      Registro := Registro + vMultaBol ; // = Posição 66 0 sem multa 2 com multa //Registro := Registro + '00000';
      ...
      Registro := Registro + '2';  // Posição 106 - Endereçamento para Aviso do Débito Automático em Conta Corrente
