...
uses
  ...
  ZAbstractRODataset, ZAbstractDataset, ZDataset, System.Actions;
...
type
  TfBotoes = class(TForm)
    ...
    Mpermitido: TWideStringField;
    Matalho: TWideStringField;
    Mdescricao: TWideStringField;
    Mnome: TWideStringField;
    Mtipo: TWideStringField;
    Mid: TIntegerField;
