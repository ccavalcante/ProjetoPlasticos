...
begin
  ...
  begin
    ...
    begin
      ...
      Registro := Registro + Formatar(IntToStr(3*NumeroRegistro+1 + vNumeroR),5,false,'0'); //9 a 13 - Número seqüencial do registro no lote - Cada título tem 2 registros (P e Q) ou R
      ...
      Registro := Registro + Formatar(Titulos[NumeroRegistro].Cedente.ContaBancaria.fDigitoAgencia,1,false,'0'); //22 a 22 - Agência mantenedora da conta
      Registro := Registro + Formatar(Titulos[NumeroRegistro].Cedente.ContaBancaria.NumeroConta,9,false,'0'); //23 a 31 - Número da conta corrente
      Registro := Registro + Formatar(Titulos[NumeroRegistro].Cedente.ContaBancaria.DigitoConta,1,false,'0'); //32 a 32 - Número da conta corrente
      ...
      Registro := Registro + Formatar(Titulos[NumeroRegistro].NossoNumero+Titulos[NumeroRegistro].DigitoNossoNumero,13,False,'0'); //45 a 57 - Nosso número - identificação do título no banco
      Registro := Registro + '5'; //58 - Código da Carteira
      ...
      Registro := Registro + Formatar(Titulos[NumeroRegistro].NumeroDocumento,15,False,'0'); //63 a 77 - Número que identifica o título na empresa
      ...
      Registro := Registro + Formatar(IntToStr(3*NumeroRegistro+2+vNumeroR),5,false,'0'); {Número seqüencial do registro no lote - Cada título tem 2 registros (P e Q)}
      ...
      {SEGMENTO R}
          ...
          Registro := Registro + Formatar(IntToStr(NumeroLote),4,false,'0'); {Número do lote}
          Registro := Registro + '3'; {Tipo do registro: Registro detalhe}
          Registro := Registro + Formatar(IntToStr(3*NumeroRegistro+3+vNumeroR),5,false,'0'); {Número seqüencial do registro no lote - Cada título tem 2 registros (P e Q)}
          ...
          if tipoMultaBoleto = 'P' then //porcentagem
             Registro := Registro + '2' //código multa porcentagem
          else
             Registro := Registro + '1'; //código multa valor
